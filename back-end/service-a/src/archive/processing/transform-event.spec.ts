...
describe('transformEvent', () => {
  ...
  it('should map eventId, eventType, actor, repo, and importId directly, when transforming any event', () => {
    const document = transformEvent(baseEvent, 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11');
    ...
    expect(document.importId).toBe('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11');
  });
  ...
  it('should whitelist ref and commitCount, when eventType is PushEvent', () => {
    ...
    expect(transformEvent(event, 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11').payload).toEqual({
      ref: 'refs/heads/main',
      commitCount: 2,
    });
  });
  ...
  it('should truncate issueTitle to 200 characters, when the title is longer', () => {
    ...
    expect(transformEvent(event, 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11').payload.issueTitle).toBe(
      longTitle.slice(0, 200),
    );
  });
