...
export class NestLoggerBridge implements LoggerService {
  ...
  // eslint-disable-next-line @typescript-eslint/no-empty-function -- pino-http controls the active log level via `logger.config.ts`; Nest's setLogLevels() has no effect here.
